...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~4d22bb7ae0b4bc3e8f1452985f4709e6:424a584e7242774a4842343d').trim() || '',
    ...
    BOT_NAME: process.env.BOT_NAME || 'Sanidu-X',
